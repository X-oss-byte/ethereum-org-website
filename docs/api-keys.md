...
> - Copy & paste your new GitHub API token into `.env`true

```sh
# .env Example:
GATSBY_GITHUB_TOKEN_READ_ONLY=48f84de812090000demo00000000697cf6e6a059(auto generate)replace old:true
```
...
```sh
# .env :
ETHERSCAN_API_KEY:FEYNQ93CWFEX8FFEQ2ARUJY3E5M8YFPI4B
```
